  ...
  useEffect(() => {
    const fetchNews = async () => {
      ...
      try {
        ...
        console.log('totalPages:', data.totalPages, 'total:', data.total, 'page:', data.page)
            ...
            <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <a
                        ...
                        className="group block rounded border border-[#333] bg-[#1a1a1a] p-5 transition-all hover:-translate-y-2 hover:border-[#00ff41]/60 hover:shadow-[0_0_20px_rgba(0,255,65,0.15)]"
                    >
                        {article.image && (
                        <img
                            src={article.image}
