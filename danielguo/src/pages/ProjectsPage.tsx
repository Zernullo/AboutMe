				...
				<div className="mx-auto max-w-5xl">
					...
					<div className="grid gap-6 md:grid-cols-2">
						{projectCards.map((project) => (
							<div
								key={project.title}
								className="rounded border border-[#333] bg-[#1a1a1a] p-5 text-left transition-all hover:-translate-y-2 hover:border-[#00ff41]/60 hover:shadow-[0_0_20px_rgba(0,255,65,0.15)]"
							>
